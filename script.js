$(document).ready(function () {
    ...
    function getForecast(searchValue) {
        $.ajax({
            type: "GET",
            url: "http://api.openweathermap.org/data/2.5/forecast?q=" + searchValue + "&appid=683c09a5969505d5268d678e16ffceba&units=imperial",
            dataType: "json",
            success: function (data) {
    ...
    function fiveDayWeather(searchValue) {
        $.ajax({
            ...
            success: function (data) {
                ...
                var title = $("<h3>").addClass("card-title").text("Current Weather In: " + data.name + "  for  " + new Date().toLocaleDateString());
